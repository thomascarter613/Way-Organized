...
The `institutional_integrity/` directory contains several generations of the integrity, safeguarding, governance-readiness, and filing-readiness system. This wrapper records which generation is current without rewriting or deleting the earlier versions.

## Current interpretation

### Unversioned root artifacts

The root-level files such as:
...
The v0.2/v0.3 trees and release packages are historical predecessors.
...
- design evolution;
- comparison;
- and reconstruction of why later controls exist.
...
Its own `70_V0_4_README.md` classifies it as:
...
None of these statuses by themselves prove:
...
- or implementation of a policy.

Those require the real-world evidence and controlled institutional records specified by the canonical institution repository.

## Relationship to canonical institution repository
...
Where an integrity instrument becomes formally adopted or operational, the adopted/current institutional record should be controlled through:

`04_INSTITUTION_AND_GOVERNANCE/institution/`

according to that repository's own control documents and adoption records.
...
## Relationship to v1.1/v1.2 releases

The v1.1/v1.2 organizational releases and the integrity v0.4 family overlap functionally in formation, board, tax, and compliance work.
...
> release/reference material remains frozen; actual adopted, executed, filed, accepted, or issued records enter the canonical institution tree only when the corresponding real-world event occurs.
